...
import spacexbg from '../assets/images/spacex-u.jpg';
...
const Hero = () => {
  ...
  return (
    <section className="flex flex-col md:flex-row items-center justify-between p-4 md:p-12" style={sectionStyle}>
      <div className="md:w-1/2 md:pr-8 bg-white bg-opacity-80 p-6 mt-4"> 
        <img src={spacexm} alt="Rocket 2" className="w-50 h-50 rounded-md mt-4" /> 
